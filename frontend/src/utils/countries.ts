export const COUNTRIES: { code: string; de: string; en: string }[] = [
  ...
  { code: "BY", de: "Weißrussland", en: "Belarus" },
  ...
  { code: "CD", de: "Kongo (Dem. Rep.)", en: "DR Congo" },
  ...
  { code: "MD", de: "Moldawien", en: "Moldova" },
...
export function getCountryName(code: string, lang: "de" | "en"): string {
